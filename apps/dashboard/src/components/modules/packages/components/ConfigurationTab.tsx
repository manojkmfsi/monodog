...
// import { DocumentTextIcon, ClipboardIcon, ClipboardDocumentCheckIcon } from '@heroicons/react/24/outline';
// import { type PackageDetail } from '../types/packages.types';
// import { useState } from 'react';
// import { monorepoService } from '../../../../services/monorepoService';
...
//     } catch (error) {
//       console.error('❌ Error saving configuration:', error);
//       setSaveMessage(error instanceof Error ? error.message : 'Failed to save configuration. Please try again.');
//     } finally {
//       setIsSaving(false);
//     }
//   };
...
//     try {
//       const contentToCopy = isEditing ? editedConfig : generatePackageJson();
...
//       // Fallback for older browsers
//       const textArea = document.createElement('textarea');
//       textArea.value = isEditing ? editedConfig : generatePackageJson();
//       document.body.appendChild(textArea);
//       textArea.select();
//       try {
//         document.execCommand('copy');
...
//   const handleCopyScript = async (scriptName: string, command: string) => {
//     try {
...
//                 <div className="flex items-center space-x-2">
//                   <button
//                     onClick={() => handleCopyScript(scriptName, command)}
//                     className={`text-sm flex items-center space-x-1 ${copiedScript === scriptName
//                       ? 'text-green-600'
//                       : 'text-gray-600 hover:text-gray-700'
//                       }`}
